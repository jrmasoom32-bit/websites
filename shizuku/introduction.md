...
2. It is almost identical to the direct invocation API experience (app developers only need to add a small amount of code)<a href="https://dontkillmyapp.com/meizu"><img id="badge-shareable" width="306px" src="https://dontkillmyapp.com/badge/meizu3.svg"></a>
